...
if ( ! function_exists( 'jas_shortcode_portfolio' ) ) {
	function jas_shortcode_portfolio( $atts, $content = null ) {
		...
		$output .= '<div class="portfolios ' . esc_attr( implode( ' ', $classes ) ) . '" data-masonry=\'{"selector":".portfolio-item", "layoutMode":"masonry" ,"columnWidth":".grid-sizer"' . ( is_rtl() ? ',"rtl": false' : ',"rtl": true' ) . '}\'>';
