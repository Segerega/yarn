...
$maps = 'row, column, heading, service, portfolio, member, blog, product, products, google-maps, wc-categories, instagram, vertical-slide, promotion, meta-slider, slider';
...
// New elements
vc_map_update( 'vc_section', array( 'icon' => 'pe-7s-menu' ) );
vc_map_update( 'vc_hoverbox', array( 'icon' => 'pe-7s-magic-wand' ) );
vc_map_update( 'vc_zigzag', array( 'icon' => 'pe-7s-graph1' ) );
