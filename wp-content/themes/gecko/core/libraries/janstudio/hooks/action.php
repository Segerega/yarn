...
if ( ! function_exists( 'jas_gecko_enqueue_scripts' ) ) {
	function jas_gecko_enqueue_scripts() {
		...
		wp_enqueue_style( 'fontawesome', JAS_GECKO_URL . '/assets/vendors/font-awesome/css/font-awesome.min.css' );
		...
		// RTL stylesheet
		if ( is_rtl() ) {
            wp_enqueue_style('jas-gecko-rtl', JAS_GECKO_URL . '/assets/css/rtl.css');
        }
